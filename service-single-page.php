...
<body>
    ...
    <div id="service-single-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 d-flex order-2 order-md-2 order-lg-1 flex-column justify-content-center pe-lg-5 pe-md-0 pe-0">
                ...
                <div class="col-lg-5 col-md-12 order-1 order-md-1 order-lg-2 p-md-5">
                    <div class="position-relative">
                        <img src="assets/img/service-img/epc.jpg" alt="" class="w-100">
                        <!-- <img src="assets/img/service-img/before-img.png" alt="" class="w-100 before"> -->
                        <span class="before d-none d-md-block"></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="service-list-items">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 px-md-5 px-lg-0">
                    <img src="assets/img/service-img/single-service-img.jpg" alt="" class="w-100">
                    <span class="before"></span>
                </div>
                <div class="col-lg-7 col-md-12 d-flex flex-column justify-content-center ps-4 ps-md-0 ps-lg-5 pt-md-5 pt-lg-0 pt-5">
                    <ul>
    ...
    <div id="service-single-list">
        <div class="container">
            ...
            <div class="d-flex align-items-start side-tab">

                <div class="row">
                    <div class="nav flex-column nav-pills me-3 me-lg-0 col-lg-3 col-12 make-sticky" id="v-pills-tab" role="tablist" aria-orientation="vertical">
